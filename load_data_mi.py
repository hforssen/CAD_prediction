...
data1_full_sd_imp1 = pd.concat([data1_standardised1, data1_full_imp1.ix[:,225]], axis=1)
data1_full_sd_imp2 = pd.concat([data1_standardised2, data1_full_imp2.ix[:,225]], axis=1)
data1_full_sd_imp3 = pd.concat([data1_standardised3, data1_full_imp3.ix[:,225]], axis=1)
data1_full_sd_imp4 = pd.concat([data1_standardised4, data1_full_imp4.ix[:,225]], axis=1)
data1_full_sd_imp5 = pd.concat([data1_standardised5, data1_full_imp5.ix[:,225]], axis=1)
