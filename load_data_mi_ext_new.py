...
data1_full_imp1 = pd.read_csv('imp_data1_nonstand.csv').ix[:,1:227]
data1_full_imp2 = pd.read_csv('imp_data2_nonstand.csv').ix[:,1:227]
data1_full_imp3 = pd.read_csv('imp_data3_nonstand.csv').ix[:,1:227]
data1_full_imp4 = pd.read_csv('imp_data4_nonstand.csv').ix[:,1:227]
data1_full_imp5 = pd.read_csv('imp_data5_nonstand.csv').ix[:,1:227]
...
age_standardised = (data_df['Age']-age_mean)/(ma.sqrt(mean_variance))

age_reset = age_standardised.reset_index().ix[:,1]
sex_reset = data_df['sex'].reset_index().ix[:,1]
statin_reset = data_df['statin'].reset_index().ix[:,1]
hypertension_reset = data_df['hypertension_4c'].reset_index().ix[:,1]


data1_full_sd_imp = pd.concat([data1_standardised, age_reset, sex_reset, statin_reset, hypertension_reset,
                               data1_full_imp.ix[:,225]], axis=1)

data1_full_sd_imp1 = pd.concat([data1_standardised1, age_reset, sex_reset, statin_reset, hypertension_reset, data1_full_imp1.ix[:,225]], axis=1)
data1_full_sd_imp2 = pd.concat([data1_standardised2, age_reset, sex_reset, statin_reset, hypertension_reset, data1_full_imp2.ix[:,225]], axis=1)
data1_full_sd_imp3 = pd.concat([data1_standardised3, age_reset, sex_reset, statin_reset, hypertension_reset, data1_full_imp3.ix[:,225]], axis=1)
data1_full_sd_imp4 = pd.concat([data1_standardised4, age_reset, sex_reset, statin_reset, hypertension_reset, data1_full_imp4.ix[:,225]], axis=1)
data1_full_sd_imp5 = pd.concat([data1_standardised5, age_reset, sex_reset, statin_reset, hypertension_reset, data1_full_imp5.ix[:,225]], axis=1)
